                ...
                <div class="row ">
                    ...
                    <div class="col-md-10" style="margin-bottom:20px;">
                        <div class="container border" style="padding: 30px;">
                            ...
                            <h3 class="text-center display-4" style="margin-bottom: 40px;">Frequently Asked Question (FAQ)</h3>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faqExample">
                                    <div class="card-body">
                                        <b>Answer:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nec lectus vehicula, scelerisque metus ac, fringilla mauris. Fusce maximus a sem nec iaculis. Phasellus accumsan posuere nulla ac hendrerit. Cras at felis enim. Pellentesque mi leo, luctus quis finibus at, vestibulum et purus. Sed eleifend ultricies urna, id ornare velit. Vivamus est magna, hendrerit ut tincidunt nec, aliquet non odio. Morbi rhoncus purus ac turpis cursus luctus. Fusce orci enim, facilisis ut hendrerit lobortis, finibus sed risus.
                                    </div>
                                </div>
                            </div>
                            <div class="card">
